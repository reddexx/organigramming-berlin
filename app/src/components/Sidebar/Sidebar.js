  ...
  (
    ...
    return (
      <>
        ...
        {embedModalShow && (
          <EmbedModal show={embedModalShow} onHide={() => setEmbedModalShow(false)} />
        )}
        {saveModalShow && (
                  ...
                  <>
                    ...
                    {mode === "admin" && (
                      <Button
                        variant="light"
                        title="Embed / Iframe"
                        onClick={() => setEmbedModalShow(true)}
                        className={embedModalShow ? "active" : ""}
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-code-square" viewBox="0 0 16 16">
                          <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zm-4.5 4.5L7.5 9l2 2L9 11l-2.5-2.5L9 6l.5-.5zm-3 0L5 6l2.5 2.5L5 11l1 1L10 9l-3.5-3.5z" />
                        </svg>
                      </Button>
                    )}
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 16 16"
                      >
                        <path d="M8.91,11.75c0,.42.39.63,1.22.63v.79H5.79v-.79q1.2,0,1.2-.63V7.49c0-.43-.4-.64-1.2-.64v-.8H8.91Zm.17-8a1.17,1.17,0,0,1-.34.84,1.13,1.13,0,0,1-.85.36,1,1,0,0,1-.47-.10A1.22,1.22,0,0,1,7,4.54a1.34,1.34,0,0,1-.26-.38,1.18,1.18,0,0,1-.09-.46A1.12,1.12,0,0,1,7,2.85a1.18,1.18,0,0,1,.85-.34,1.11,1.11,0,0,1,.84.35A1.15,1.15,0,0,1,9.08,3.7Z" />
                      </svg>
                    </Button>
