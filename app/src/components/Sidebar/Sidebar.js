...
import React, {
  ...
  forwardRef,
            ...
            <Nav>
              <ButtonGroup className="undo-redo-group">
                <Button
                  ...
                  disabled={!enableUndo || mode === "viewer"}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
        ...
        c0.3,0,0.5,0.1,0.6,0.4c0,0,0,0,0,0C14.3,8.1,12,11.1,8.7,11.5z"
                ...
                <Button
                  onClick={onRedo}
                  disabled={!enableRedo || mode === "viewer"}
